...
('Astronaute', 'Première poule sur la Lune. Elle a pondu dans l’espace.', 35, 22.06, 26.47, 26.47, 'astronaute.png', 'déguisement', 7),
...
('Chevalier', 'Défend le poulailler avec courage et cotte de mailles.', 37, 18.76, 22.51, 22.51, 'chevalier.png', 'déguisement', 2),
...
('Chanteur Jul', 'Pas de casque pour pas écraser sa crête : la poule du quartier est là, prête au rodéo.', 16, 19.77, 23.72, 23.72, 'jul.png', 'déguisement', 4),
('Licorne', 'Une poule magique qui pond des arcs-en-ciel.', 21, 24.31, 29.17, 29.17, 'licorne.png', 'déguisement', 1),
('Link', 'Vêtue d’une tunique verte, capuche sur la crête et bouclier miniature attaché à l’aile, cette poule héroïque traverse le royaume de Poulruda pour sauver la princesse oeufda.', 34, 18.47, 22.16, 22.16, 'link.png', 'déguisement', 1),
...
('Pieuvre', 'Avec huit tentacules cousus à ses ailes, elle nage dans les flaques comme personne.', 38, 23.76, 28.51, 28.51, 'pieuvre.png', 'déguisement', 8),
...
--  accessoires 
INSERT INTO product (name_product, description, stock, price_ht, price_ttc, price_discount, image_link, category, id_subcategory) VALUES
('Baguette de Fée', 'Avec cette baguette, vous êtes prête à exaucer tous vos souhaits… ou à jeter un sort aux mauvaises herbes.', 50, 12.99, 15.59, 15.59, 'baguette-fee.png', 'accessoire', 1),
('Casque de Chevalier', 'Enfilez ce casque et devenez la garde royale du poulailler. Un coup d’épée et les graines sont à vous !', 40, 18.47, 22.16, 22.16, 'casque-chevalier.png', 'accessoire', 2),
('Casque Militaire', 'Ce casque est parfait pour les missions secrètes… ou pour cacher des plumes rebelles pendant l’opération "poules en formation".', 35, 20.32, 24.38, 24.38, 'casque-militaire.png', 'accessoire', 3),
('Casque de Viking', 'Soyez prêt à partir à l’assaut des graines avec ce casque orné de cornes. Parfait pour un raid épique… ou un déjeuner !', 28, 19.15, 22.98, 22.98, 'casque-viking.png', 'accessoire', 2),
